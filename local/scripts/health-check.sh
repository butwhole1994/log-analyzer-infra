...
KAFKA_TOPIC_LOG_EVENTS="${KAFKA_TOPIC_LOG_EVENTS:-mvp.log-events}"
KAFKA_TOPIC_LOG_EVENTS_DLQ="${KAFKA_TOPIC_LOG_EVENTS_DLQ:-mvp.log-events-dlq}"
...
OPENSEARCH_INDEX_PATTERN="${OPENSEARCH_INDEX_PATTERN:-logs-*}"
OPENSEARCH_READ_ALIAS="${OPENSEARCH_READ_ALIAS:-logs-read}"
OPENSEARCH_WRITE_ALIAS="${OPENSEARCH_WRITE_ALIAS:-logs-write}"
OPENSEARCH_PIPELINE_NAME="${OPENSEARCH_PIPELINE_NAME:-logs-pipeline}"
